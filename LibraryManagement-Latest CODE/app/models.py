...
class customuser(AbstractUser):
    ...
    profile_pic = models.ImageField(upload_to='app/profile_pics', null=True, blank=True)
...
class Order(models.Model):
    ...
    delivery_status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='processing')
